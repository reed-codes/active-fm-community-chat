...
const DropZone = (props) => {
  return (
    <Box
      ...
      className="absolute top-[50%] left-[50%] flex justify-center flex-col basis-[505px] rounded-xl w-full h-full max-h-[508px] max-w-[75%] lg:max-w-[505px] bg-[#222] overflow-hidden"
    >
      <Box className="bg-[#aa2329] font-bold truncate text-[16px] h-[45px] flex items-center justify-between border-b-[1px] border-solid border-[#00312d] absolute z-100 top-0 left-0 right-0">
        <Button
...
const DropZoneContent = () => {
  return (
    <>
      ...
      <Box className="mb-5 text-[22px]">'Drag n drop' image</Box>
      <Button variant="contained">Click to Select from files</Button>
    </>
  );
};
...
const PostMetadataForm = (props) => {
  return (
    <Box
      ...
      className="absolute top-[50%] left-[50%] flex justify-center flex-col basis-[505px] rounded-xl overflow-hidden w-full h-full max-h-[508px] max-w-[75%] lg:max-w-[505px] bg-[#222]"
    >
      <Box className="font-bold truncate text-[16px] h-[45px] flex items-center justify-between border-b-[1px] border-solid bg-[#aa2329] absolute z-[1000] top-0 left-0 right-0">
