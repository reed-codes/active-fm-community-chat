...
const RecordPanel = ({ handleDiscardRecording, record, send }) => {
  ...
  return (
    <>
      <Box className="fixed z-[100] left-0 top-0 w-full h-full bg-[#00312d] flex gap-2 items-center px-4">
        <Box className="flex flex-1 h-full">
          ...
          <Box className="h-full flex-1 flex items-center justify-center">
            <Box className="p-2 rounded-lg bg-[#02211e] flex items-center justify-center gap-3"
                 style = {{
                  border: '1px #09433d solid'
                 }}
                 >
              <IconButton
